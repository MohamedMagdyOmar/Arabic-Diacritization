...
import sys, getopt, codecs, os, re, io
import glob

path = 'C:\Users\Mohamed Magdy\Desktop\Test'
extension = 'txt'


def Buck_To_Unicode_Converter(file_name):
    ...
    inFilename = "C:\Users\Mohamed Magdy\Desktop\Test\\" + file_name  # Name of filename containing input.
    outFilename = "C:\Users\Mohamed Magdy\Desktop\Test2\\" + file_name # Name of filename to send the output
...
if __name__ == "__main__":
    ...
    for file_name in result:
        with io.FileIO('C:\Users\Mohamed Magdy\Desktop\Test2\\' + file_name, "w") as file:
            Buck_To_Unicode_Converter(file_name)
            print file_name