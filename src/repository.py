...
class Repository:
    ...
    def get_data_set(self):
        ...
        self.query = "select UnDiacritizedCharacter, Diacritics, LetterType, SentenceNumber,Word, " \
                     "DiacritizedCharacter, location from dataset order by SentenceNumber asc, " \
    ...
    def get_dataset_sentence_numbers_using_category(self, category):
        """
        old name: get_list_of_sentence_numbers_by
        sentence_type: string :training, testing
        """

        self.query = "select distinct SentenceNumber from dataset where LetterType = " + \
                     "'" + category + "'" + " order by SentenceNumber asc, idCharacterNumber asc "
    ...
    def get_dataset_by_sentence_number_category(self, sentence_number, category):
        """
        ...
        """
        self.query = "select UnDiacritizedCharacter, Diacritics, LetterType, SentenceNumber,Word, " \
                     "DiacritizedCharacter, location, UnDiacritizedWord from dataset where LetterType=" + \
    ...
    def get_dataset_un_diacritized_chars_by_sentence_number_category(self, sentence_number, category):
        ...
        category: string: : training, testing
        """
        self.query = "select UnDiacritizedCharacter from dataset where " \
    ...
    def get_dataset_diacritized_chars_by_sentence_number_category(self, sentence_number, category):
        ...
        category: string: : training, testing
        """
        self.query = "select DiacritizedCharacter from dataset where " \
                     "LetterType = " + "'" + category + "'" + "and SentenceNumber = " + str(sentence_number)
    ...
    def get_dataset_by_sentence_number_category_for_testing_purpose(self, category, sentence_number):
        """
    ...
    def get_testing_dataset(self):
        ...
        self.query = "select UnDiacritizedCharacter, Diacritics, LetterType, SentenceNumber,Word, " \
                     "DiacritizedCharacter, location, UnDiacritizedWord from dataset where LetterType=" + \
                     "'%s'" % "testing order by SentenceNumber asc, idCharacterNumber asc"
    ...
    def get_dataset_un_diacritized_words_and_sentence_number_using_category(self, category):
        """
    ...
    def get_diacritized_versions_using_undiacritized_word(self, un_diacritized_word):
        """
