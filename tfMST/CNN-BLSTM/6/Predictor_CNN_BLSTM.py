...
if __name__ == "__main__":
    ...
    model = load_model('weights.010-0.9310.hdf5')
    print(model.summary())
    ...
    for sentence_number in list_of_sentence_numbers:
        ...
        error.append(DERCalculationHelperMethod.get_diacritization_error_version_2(RNN_Predicted_Chars_After_Fatha,
        ...
        error_without_last_letter.append(DERCalculationHelperMethod.
                                         ...
                                         (RNN_Predicted_Chars_After_Fatha, sentence_number, selected_sentence1))
        '''
