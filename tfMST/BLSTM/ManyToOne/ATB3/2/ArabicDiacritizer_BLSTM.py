...
if __name__ == "__main__":
    ...
    model.add(Bidirectional(LSTM(250, dropout=0.2, recurrent_dropout=0.2, return_sequences=True), merge_mode='sum'))
    model.add(Bidirectional(LSTM(350, dropout=0.2, recurrent_dropout=0.2, return_sequences=True), merge_mode='sum'))
    model.add(Bidirectional(LSTM(250, dropout=0.2, recurrent_dropout=0.2), merge_mode='sum'))
